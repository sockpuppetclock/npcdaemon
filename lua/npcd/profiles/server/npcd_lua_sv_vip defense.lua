...
local profile_name = npcd.CreateEmptyProfile( "vip defense", true ) // set profile_name to nil to use currently active profile
...
npcd.CreatePreset( "npc", "VIP (Mission Critical)", {
	["VERSION"] = 20,
	["beacon"] = true,
	["chase_preset"] = {
		[1] = {
...
npcd.CreatePreset( "npc", "Metropolice", {
	["VERSION"] = 20,
	["classname"] = {
...
npcd.CreatePreset( "squad", "Soldiers", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnlist"] = {
		[1] = {
...
npcd.CreatePreset( "squad", "Metropolices", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnlist"] = {
		[1] = {
...
npcd.CreatePreset( "squad", "Elite Soldiers", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnlist"] = {
		[1] = {
...
npcd.CreatePreset( "squad", "Marker", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "entity", "Destination", {
	["VERSION"] = 20,
	["angle"] = Angle( 0, 0, 90 ),
