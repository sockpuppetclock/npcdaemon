...
local profile_name = npcd.CreateEmptyProfile( "chaos kit", true ) // set profile_name to nil to use currently active profile

-- npcd.ClearProfile( profile_name ) // (optional) empty out existing profile
-- npcd.SwitchProfile( profile_name )

npcd.CreatePreset( "player", "Kill Bonus", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "player", "Hunger", {
	["VERSION"] = 20,
	["damagefilter_out"] = {
		[1] = {
			["attacker"] = {
...
npcd.CreatePreset( "player", "Headshots Only", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "player", "Low Gravity", {
	["VERSION"] = 20,
	["entity_type"] = "player",
	["expected"] = {
		["d"] = 1,
...
npcd.CreatePreset( "player", "Go Fast", {
	["VERSION"] = 20,
	["accelerate"] = {
		["accel_rate"] = 150,
...
npcd.CreatePreset( "player", "Cool Materials", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "player", "High Impact", {
	["VERSION"] = 20,
	["accelerate"] = {
		["accel_rate"] = 80,
		["accel_threshold"] = 1500,
...
npcd.CreatePreset( "player", "Jello Boy", {
	["VERSION"] = 20,
	["damage_drop_set"] = {
		[1] = {
			["drop_set"] = {
...
npcd.CreatePreset( "player", "Invincible", {
	["VERSION"] = 20,
	["entity_type"] = "player",
	["expected"] = {
		["d"] = 0,
...
npcd.CreatePreset( "drop_set", "Fear Determination, Least", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "drop_set", "Buckcrab Persistence", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["chance"] = {
...
npcd.CreatePreset( "drop_set", "Bomber", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["preset_values"] = {
...
npcd.CreatePreset( "drop_set", "Bomb", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["preset_values"] = {
...
npcd.CreatePreset( "drop_set", "Clown Car", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["preset_values"] = {
...
npcd.CreatePreset( "drop_set", "Miniscule Level Drops", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "drop_set", "High Level Drops", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "drop_set", "Grand Level Drops", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "drop_set", "AR2 Egg", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["destroydelay"] = 180,
...
npcd.CreatePreset( "drop_set", "Fear Determination, One", {
	["VERSION"] = 20,
	["count_per_squad_spawn"] = true,
	["drops"] = {
		[1] = {
...
npcd.CreatePreset( "drop_set", "Headcrab Persistence", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["chance"] = {
...
npcd.CreatePreset( "drop_set", "Fear Determination, Lesser", {
	["VERSION"] = 20,
	["count_per_squad_spawn"] = true,
	["drops"] = {
		[1] = {
...
npcd.CreatePreset( "drop_set", "Low Level Drops", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "drop_set", "Large Rocket", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["destroydelay"] = 180,
...
npcd.CreatePreset( "drop_set", "Medium Level Drops", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "drop_set", "Pick Up That Tab", {
	["VERSION"] = 20,
	["description"] = "",
	["drops"] = {
		[1] = {
...
npcd.CreatePreset( "drop_set", "Yum", {
	["VERSION"] = 20,
	["drops"] = {
		[1] = {
			["destroydelay"] = 30,
...
npcd.CreatePreset( "npc", "Combine Elitist", {
	["VERSION"] = 20,
	["animspeed"] = 0.7,
...
npcd.CreatePreset( "npc", "Tiny Party Favors", {
	["VERSION"] = 20,
	["activate"] = false,
...
npcd.CreatePreset( "npc", "Insane Beer Lover", {
	["VERSION"] = 20,
	["bones"] = {
		[1] = {
			["bone"] = {
...
npcd.CreatePreset( "npc", "High Burst", {
	["VERSION"] = 20,
	["classname"] = {
		["name"] = "npc_magnusson",
		["type"] = "NPC",
...
npcd.CreatePreset( "npc", "Zexplosive Zombie", {
	["VERSION"] = 20,
	["angle"] = {
		[1] = "__RANDOMANGLE",
	},
...
npcd.CreatePreset( "npc", "Drone Strike", {
	["VERSION"] = 20,
	["accelerate"] = {
		["accel_rate"] = 45,
		["accel_threshold"] = 400,
...
npcd.CreatePreset( "npc", "One Fear", {
	["VERSION"] = 20,
	["classname"] = {
...
npcd.CreatePreset( "npc", "Antlioness", {
	["VERSION"] = 20,
	["angle"] = {
		[1] = "__RANDOMANGLE",
	},
...
npcd.CreatePreset( "npc", "Tiny Clown", {
	["VERSION"] = 20,
	["bloodcolor"] = {
		[1] = "__TBLRANDOM",
		[2] = "BLOOD_COLOR_RED",
...
npcd.CreatePreset( "npc", "Party Favors", {
	["VERSION"] = 20,
	["activate"] = false,
	["bloodcolor"] = "DONT_BLEED",
	["classname"] = {
...
npcd.CreatePreset( "npc", "Rebel Rat", {
	["VERSION"] = 20,
	["animspeed"] = 1.35,
...
npcd.CreatePreset( "npc", "Brainhack", {
	["VERSION"] = 20,
	["accelerate"] = {
		["accel_rate"] = 37,
		["accel_threshold"] = 410,
...
npcd.CreatePreset( "npc", "Tumbleweed", {
	["VERSION"] = 20,
	["accelerate"] = {
	},
	["classname"] = {
...
npcd.CreatePreset( "npc", "Soldier Boy", {
	["VERSION"] = 20,
	["bones"] = {
		[1] = {
			["bone"] = "L_Foot",
...
npcd.CreatePreset( "npc", "Rebel Giant Rat", {
	["VERSION"] = 20,
	["animspeed"] = 0.75,
	["bloodcolor"] = "BLOOD_COLOR_YELLOW",
	["citizentype"] = {
...
npcd.CreatePreset( "npc", "Persistent Headcrab", {
	["VERSION"] = 20,
	["classname"] = {
		["name"] = "npc_headcrab",
		["type"] = "NPC",
...
npcd.CreatePreset( "npc", "Nicht Keiner", {
	LOOKUP_REROLL = {
		["actdelay"] = true,
		["activity"] = true,
	},
...
npcd.CreatePreset( "npc", "Metro Clown", {
	["VERSION"] = 20,
	["bloodcolor"] = {
		[1] = "__TBLRANDOM",
		[2] = "BLOOD_COLOR_RED",
...
npcd.CreatePreset( "npc", "Normal Citizen", {
	["VERSION"] = 20,
	["bloodcolor"] = "BLOOD_COLOR_RED",
	["citizentype"] = {
		[1] = "__RANDOM",
...
npcd.CreatePreset( "npc", "Proxy Cop", {
	["VERSION"] = 20,
	["animspeed"] = 2,
	["bloodcolor"] = "DONT_BLEED",
	["bones"] = {
...
npcd.CreatePreset( "squad", "Dancing Bugmen", {
	["VERSION"] = 20,
	["description"] = "Friends",
	["mapmax"] = 2,
	["npcd_enabled"] = true,
...
npcd.CreatePreset( "squad", "Lil Silly", {
	["VERSION"] = 20,
	["fadein"] = true,
	["npcd_enabled"] = true,
	["spawnlist"] = {
...
npcd.CreatePreset( "squad", "One Fear", {
	["VERSION"] = 20,
	["announce_death"] = true,
	["announce_spawn"] = true,
...
npcd.CreatePreset( "squad", "Rebel Rats", {
	["VERSION"] = 20,
	["fadein"] = true,
	["hivequeen"] = {
...
npcd.CreatePreset( "squad", "The Machine", {
	["VERSION"] = 20,
	["announce_color"] = {
		[1] = "__RANDOMCOLOR",
		[2] = 340,
...
npcd.CreatePreset( "squad", "Soldier Boys", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnlist"] = {
		[1] = {
...
npcd.CreatePreset( "squad", "Fireflies", {
	["VERSION"] = 20,
	["fadein"] = true,
	["npcd_enabled"] = true,
	["spawnlist"] = {
...
npcd.CreatePreset( "squad", "Couch Fountains", {
	["VERSION"] = 20,
	["fadein"] = false,
	["mapmax"] = 5,
	["mindelay"] = 160,
...
npcd.CreatePreset( "squad", "New Men", {
	["VERSION"] = 20,
	["mapmax"] = 2,
	["nocollide"] = true,
	["npcd_enabled"] = true,
...
npcd.CreatePreset( "squad", "Now About That Beer I Ow", {
	["VERSION"] = 20,
	["announce_all"] = true,
...
npcd.CreatePreset( "squad", "IT HAS A GUN", {
	["VERSION"] = 20,
	["announce_all"] = true,
...
npcd.CreatePreset( "squad", "Drone Warfare", {
	["VERSION"] = 20,
	["fadein_nodelay"] = true,
	["mapmax"] = 2,
	["npcd_enabled"] = true,
...
npcd.CreatePreset( "squad", "The Vorts", {
	["VERSION"] = 20,
	["npcd_enabled"] = false,
	["override_hard"] = {
		["npc"] = {
...
npcd.CreatePreset( "squad", "Many, Many Fears", {
	["VERSION"] = 20,
	["announce_death"] = true,
...
npcd.CreatePreset( "squad", "No-Brainer", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "squad", "Bombing Run", {
	["VERSION"] = 20,
	["announce_color"] = {
		[1] = "__RANDOMCOLOR",
		[3] = 0,
...
npcd.CreatePreset( "squad", "The Vortest", {
	["VERSION"] = 20,
	["announce_all"] = true,
	["mapmax"] = 2,
	["npcd_enabled"] = true,
...
npcd.CreatePreset( "squad", "Many Fears", {
	["VERSION"] = 20,
	["announce_death"] = true,
	["announce_spawn"] = false,
...
npcd.CreatePreset( "squad", "Persistent Headcrab", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnlist"] = {
		[1] = {
...
npcd.CreatePreset( "squad", "Metro Clowns", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnlist"] = {
		[1] = {
...
npcd.CreatePreset( "squad", "Antlioness", {
	["VERSION"] = 20,
	["fadein_nodelay"] = true,
	["mapmax"] = 2,
	["mindelay"] = 300,
...
npcd.CreatePreset( "squad", "Zexplosive Zombies", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnforce"] = {
		["forward"] = {
...
npcd.CreatePreset( "squad", "No-Brainer (2)", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "squad", "Elitists", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["spawnlist"] = {
		[1] = {
...
npcd.CreatePreset( "weapon_set", "Quake 3", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "weapon_set", "Warning Shotty", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "weapon_set", "Wowozela", {
	["VERSION"] = 20,
	["npcd_enabled"] = false,
	["weapons"] = {
		[1] = {
...
npcd.CreatePreset( "weapon_set", "Max Ar2y", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["weapons"] = {
		[1] = {
...
npcd.CreatePreset( "weapon_set", "RPinGas", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["weapons"] = {
		[1] = {
...
npcd.CreatePreset( "weapon_set", "Max Smggy", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["weapons"] = {
		[1] = {
...
npcd.CreatePreset( "weapon_set", "Max Shotty", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["weapons"] = {
		[1] = {
...
npcd.CreatePreset( "weapon_set", "Full Mangun", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["weapons"] = {
		[1] = {
...
npcd.CreatePreset( "weapon_set", "Doom", {
	["VERSION"] = 20,
...
npcd.CreatePreset( "weapon_set", "HL2 Pistol Wireframe", {
	["VERSION"] = 20,
	["npcd_enabled"] = true,
	["override_hard"] = {
		["weapon"] = {
...
npcd.CreatePreset( "entity", "Pick Me Up", {
	["VERSION"] = 20,
	["allow_chased"] = true,
	["classname"] = "prop_physics",
...
npcd.CreatePreset( "entity", "Couch Fountain", {
	["VERSION"] = 20,
	["classname"] = "prop_physics",
	["damage_drop_set"] = {
		[1] = {
