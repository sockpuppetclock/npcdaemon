...
t_squad_values = {
	...
	["mapmax"] = {
		NAME = "Max Squad Spawns",
		CATEGORY = t_CAT.LIMIT,
		DESC = "Max amount of this squad allowed on the map at once",
		-- -- FUNCTION = {}, --[[ Direct() ]]
	},
	["mapmin"] = {
		NAME = "Min Squad Spawns",
		CATEGORY = t_CAT.LIMIT,
...
t_spawnpool_values = {
	...
	["spawn_autoadjust"] = {
		...
		TYPE = "boolean",
		DESC = "Allow the pool's spawn/squad limits to be adjusted by mapscale or cvars (see: npcd Options > Spawn Radius & Limits)",
		DEFAULT = true,
		-- DEFAULT_SAVE = true,
		NOFUNC = true,
		SORTNAME = "n",
	...
	["pool_spawnlimit"] = {
		CATEGORY = t_CAT.LIMIT,
		NAME = "Pool Entity Limit",
		DESC = "Limits entities from spawnpool. Measured by quota-weight of spawnpool's entities. Radiuses can also have their own limits",
		SORTNAME = "c",
	},
	["pool_squadlimit"] = {
		CATEGORY = t_CAT.LIMIT,
		NAME = "Pool Squad Limit",
		DESC = "Limits squads from squadpool. Measured by number of separate squads. Radiuses can also have their own limits",
		SORTNAME = "d",
	},
	["minpressure"] = {
		CATEGORY = t_CAT.NPCD,
