...
t_value_structs["damagefilter"] = {  
	...
	NAME = "Damage Filter",
	DESC = "Filters, if passed, conditionally adjust damage and allow other effects to both attacker and victim. The filters are tested from top to bottom, ending after any filter passes",
...
t_active_values = {
	...
	["damagefilter_post_in"] = {
		...
		DESC = "Checks AFTER damage is taken. On default conditions, only damage that the entity actually takes can pass. Allow other effects to both attacker and victim if passed. The filters are tested from top to bottom, ending after any filter passes",
		TYPE = "struct_table",
		STRUCT = {
	...
	["physcollide"] = {
		...
		STRUCT = {
			...
			["damagefilter_out"] = {
				NAME = "Damage Filter: Outgoing",
				-- CATEGORY = t_CAT.COMBAT,
				DESC = "(Applied for every entity hit) Filters, if passed, conditionally adjust damage and allow other effects to both attacker and victim. The filters are tested from top to bottom, ending after any filter passes",
				TYPE = "struct_table",
				STRUCT = t_value_structs["damagefilter"].STRUCT,
			},
			["speed_min"] = {
